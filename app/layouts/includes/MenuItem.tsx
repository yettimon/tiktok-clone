...
export default function MenuItem({ iconString, colorString, sizeString }: MenuItemsType) {
    const icons = () => {
        ...
        <>
            <div className="w-full flex items-center hover:bg-gray-100 p-2.5 rounded-md">
                <div className="flex items-center lg:mx-0 mx-auto">
                    {icons()}
                    <p
                        className={`lg:block hidden pl-[9px] mt-0.5 font-semibold text-[17px] text-[${colorString}]`}></p>
                    {iconString}
                </div>
            </div>
        </>
