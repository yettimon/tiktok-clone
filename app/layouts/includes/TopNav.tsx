...
export default function TopNav() {
    ...
    return (
        <>
            <div id="navbar" className="fixed bg-white flex items-center w-full z-20 border-b lg:px-2.5 mx-auto ">
                <div
                    ...
                    <Link href="/" className="flex items-center flex-column">
                        <img className="min-w-[50px] w-[50px]" src="/images/logo-tiktok.svg" />
                        Tiktok
                    </Link>
